...
const FACTIONS: FactionSeed[] = [
  ...
  { id: 'undead_legions',   name: 'Undead Legions',    race: 'Undead',      category: FactionCategory.UNDEAD,      color_hex: '#4B2E5E', display_order: 25, icon_url: '/icons/factions/undead_legions_v3.png' },
