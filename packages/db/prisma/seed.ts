...
const MAP_DATA: { name: string; image_url: string | null }[] = [
  { name: 'Altar of Hashut',           image_url: 'https://i.imgur.com/LvLOtgm.jpeg' },
  { name: 'Altar of the Champion',     image_url: 'https://i.imgur.com/yz5oLma.jpeg' },
  { name: 'Altdorf Farmlands',         image_url: 'https://i.imgur.com/cC1nDSM.jpeg' },
  { name: 'Aracknarock Lair',          image_url: 'https://i.imgur.com/saz9JBu.jpeg' },
  { name: "Arbiter's Ground",          image_url: 'https://i.imgur.com/sJXZxLk.jpeg' },
  { name: 'Battered Bluff',            image_url: 'https://i.imgur.com/LZh0MZh.jpeg' },
  { name: 'Blasphemous Snowfield',     image_url: '/maps/blasphemous-snowfield.png' },
  { name: 'Bleakspire Labour Camp',    image_url: 'https://i.imgur.com/Ej0FME2.jpeg' },
  ...
  { name: 'Clash of Chaos',            image_url: 'https://i.imgur.com/z9ZUKKb.jpeg' },
  { name: "Coedill's Mistwood",        image_url: 'https://i.imgur.com/dmsiCrL.jpeg' },
  { name: 'Crater of Decay',           image_url: 'https://i.imgur.com/l75rvWR.jpeg' },
  ...
  { name: 'Dunes of Setep',            image_url: 'https://i.imgur.com/VvHaExd.jpeg' },
  { name: 'Dustbowl',                  image_url: 'https://i.imgur.com/fbeT1cA.jpeg' },
  { name: 'Dusted Steppe',             image_url: 'https://i.imgur.com/57xWtNs.jpeg' },
  ...
  { name: 'Excavation Site',           image_url: 'https://i.imgur.com/YjKKcG7.jpeg' },
  { name: 'Gates of Ekrund',           image_url: 'https://i.imgur.com/wQVUIpP.jpeg' },
  { name: 'Geothermal Crevice',        image_url: 'https://i.imgur.com/xe8naxj.jpeg' },
  { name: 'Geyser Bluff',              image_url: 'https://i.imgur.com/NgyRe7T.jpeg' },
  ...
  { name: 'Graveyard of Altdorf',      image_url: 'https://i.imgur.com/lb1ceE9.jpeg' },
  { name: 'Halls of Karag Dum',        image_url: 'https://i.imgur.com/JU2Kw3Q.jpeg' },
  ...
  { name: 'Hell Pit Depths',           image_url: 'https://i.imgur.com/UEqYAd3.jpeg' },
  { name: 'Imperial Ambush',           image_url: 'https://i.imgur.com/aFXp5qw.jpeg' },
  { name: 'Imperial Road',             image_url: 'https://i.imgur.com/wiMbaFw.jpeg' },
  { name: 'Isle of Forgotten Kings',   image_url: 'https://i.imgur.com/lCAk02w.jpeg' },
  ...
  { name: 'Lost Isles of Culchan',     image_url: 'https://i.imgur.com/leiTOnn.jpeg' },
  { name: 'Lost Temple of Sotek',      image_url: 'https://i.imgur.com/UpMzR5h.jpeg' },
  { name: 'Lustrian Narrows',          image_url: 'https://i.imgur.com/tHRMHIq.jpeg' },
  { name: 'Mercenaries of Tilea',      image_url: 'https://i.imgur.com/4GvTXgU.jpeg' },
  { name: 'Needlemyst Isle',           image_url: 'https://i.imgur.com/1Shgs8S.jpeg' },
  { name: 'Nehekharan Wastes',         image_url: 'https://i.imgur.com/dPIOj0V.jpeg' },
  { name: 'Norscan Rise',              image_url: 'https://i.imgur.com/olAbf3U.jpeg' },
  { name: 'Nuln Outskirts',            image_url: 'https://i.imgur.com/M5x1wKX.jpeg' },
  { name: 'Oakenshield',               image_url: 'https://i.imgur.com/7TzyZNQ.jpeg' },
  { name: 'Oasis of Zedri',            image_url: 'https://i.imgur.com/eBMHHuD.jpeg' },
  { name: 'Otsuchi Castle',            image_url: 'https://i.imgur.com/RskXrIz.jpeg' },
  { name: 'Pit of the Everchosen',     image_url: 'https://i.imgur.com/Dlp5XAh.jpeg' },
  { name: 'Pit of Treasures',          image_url: 'https://i.imgur.com/ozsRahD.jpeg' },
  ...
  { name: "Rift at the World's Edge",  image_url: 'https://i.imgur.com/USxlGQx.jpeg' },
  { name: 'Road to Talabheim',         image_url: 'https://i.imgur.com/c7xXQvx.jpeg' },
  { name: "Road to Vaul's Anvil",      image_url: 'https://i.imgur.com/TnwQx8Y.jpeg' },
  { name: 'Ruins of Arrogance',        image_url: 'https://i.imgur.com/UfzOp5j.jpeg' },
  { name: 'Sacred Cenote of Chaqua',   image_url: 'https://i.imgur.com/GaZPOtr.jpeg' },
  { name: 'Shambling Bog',             image_url: 'https://i.imgur.com/65px0d0.jpeg' },
  { name: 'Siege of Salernum',         image_url: 'https://i.imgur.com/RGdRLek.jpeg' },
  { name: "Skjalandir's Cave",         image_url: 'https://i.imgur.com/NtZ1Rxn.jpeg' },
  { name: "Stone'enge",                image_url: 'https://i.imgur.com/7EcIhGa.jpeg' },
  { name: 'Sunken Mire',               image_url: 'https://i.imgur.com/MbIcKyg.jpeg' },
  { name: 'Talabheim Crater',          image_url: 'https://i.imgur.com/5WkgGst.jpeg' },
  { name: 'Temple of Usirian',         image_url: 'https://i.imgur.com/IKSZxe2.jpeg' },
  { name: 'Terracotta Graveyard',      image_url: 'https://i.imgur.com/cK0RCn7.jpeg' },
  { name: 'The Arena',                 image_url: 'https://i.imgur.com/E2fTPnc.jpeg' },
  { name: 'The Blazing Ramparts',      image_url: 'https://i.imgur.com/V7uKLph.jpeg' },
  ...
  { name: 'The Crucible',              image_url: 'https://i.imgur.com/b4HCX1N.jpeg' },
  { name: "The Hag's Conclave",        image_url: 'https://i.imgur.com/nUCNRaA.jpeg' },
  { name: 'The Mountain of Truth',     image_url: 'https://i.imgur.com/90iybRZ.jpeg' },
  { name: 'The Sword of the Lake',     image_url: 'https://i.imgur.com/Yog7p4C.jpeg' },
  { name: 'The Valley of Lies',        image_url: 'https://i.imgur.com/XOll0lj.jpeg' },
  { name: 'The Vanishing Steppe',      image_url: 'https://i.imgur.com/AZAPl4d.jpeg' },
  { name: 'Twilight Forest',           image_url: 'https://i.imgur.com/bI2jrWf.jpeg' },
  { name: "Urgot's Stompin Groundz",   image_url: 'https://i.imgur.com/cUEXhx4.jpeg' },
  { name: 'Vineyards of Varieno',      image_url: 'https://i.imgur.com/WdgHVPF.jpeg' },
  { name: 'Whirling Maelstrom',        image_url: 'https://i.imgur.com/VvrCxyx.jpeg' },
  { name: 'Womb of Sorrow',            image_url: 'https://i.imgur.com/xOoNocf.jpeg' },
  { name: 'Zharr-Naggrund Rebellion',  image_url: 'https://i.imgur.com/BjdIfUG.jpeg' },
];
