...
>
> Diese Roadmap ist die **SSOT** für *was läuft*, *was als nächstes drankommt* und *was bewusst nicht gebaut wird*. Sub-Pläne (Detail-Plans für einzelne Tracks) liegen unter `~/.claude/plans/`, nicht im Repo. Historie und Welle-Specs siehe `docs/archive/`.
...
## 4. M6 — Hub-Foundation *(1–2 Wochen)*
...
## 5. M7 — Datentiefe & Army-List-Database *(2–3 Wochen)*
...
## 7. M8 — UGC & Battle-Reports *(3–4 Wochen, transformativ)*
...
## 8. M9 — Team-Play *(4+ Wochen, große Wette)*
