...
//
// Linux baseline PNGs (-chromium-linux.png) are committed, so these specs run
// in normal CI. To regenerate baselines after intended visual changes, run the
// `update-snapshots.yml` workflow (playwright --update-snapshots on ubuntu-latest)
