  ...
  return (
    <div data-testid="onboarding-stage-1" className="w-full max-w-2xl">
      <motion.div
        ...
        className="w-full rounded-md border border-rizzotto-iron-700 bg-rizzotto-iron-900 p-8 shadow-rizzotto-banner"
      >
        <h2 className="font-headline text-rizzotto-stone-100" style={{ fontSize: 'clamp(1.5rem, 3vw, 2rem)' }}>
          {t('onboarding.stage2.title')}
        </h2>
        <p className="mt-2 font-sans text-sm leading-relaxed text-rizzotto-stone-300">
        ...
        <div className="mt-8 space-y-7">
          <div>
            <label
              ...
              className="block font-display text-[11px] uppercase tracking-[0.18em] text-rizzotto-gold-500"
            >
            ...
            <select
              ...
              className="mt-2 w-full rounded-sm border border-rizzotto-iron-600 bg-rizzotto-iron-800 px-3 py-2 font-sans text-sm text-rizzotto-stone-200 focus:border-rizzotto-gold-500 focus:outline-none focus:ring-2 focus:ring-rizzotto-gold-500/40"
            >
            ...
            <p className="mt-1 text-[11px] text-rizzotto-stone-400">
              Auto-detected: {defaultTz}
            </p>
          </div>

          <div>
            <span className="block font-display text-[11px] uppercase tracking-[0.18em] text-rizzotto-gold-500">
              {t('onboarding.stage2.factions_label')}
            </span>
            <p className="mt-1 mb-3 text-[11px] text-rizzotto-stone-400">
