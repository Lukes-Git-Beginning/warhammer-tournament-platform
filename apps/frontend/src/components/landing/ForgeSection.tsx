    ...
    <section aria-labelledby="forge-heading" className="relative py-16 lg:py-20">
      ...
      <div className="relative mx-auto grid max-w-[80rem] grid-cols-1 items-center gap-10 px-4 sm:px-6 lg:grid-cols-3 lg:gap-16 lg:px-8 xl:gap-20 xl:px-12">
        ...
        <motion.div
          ...
          className="karaz-photo-frame relative mx-auto aspect-[3/4] w-full min-w-0 max-h-[560px] overflow-hidden rounded-lg ring-1 ring-karaz-iron-600 shadow-karaz-banner lg:col-span-1 lg:max-h-[640px]"
        >
          <Picture
            src="/img/forge-anvil"
            alt=""
